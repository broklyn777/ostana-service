...
<ul className="" >     {/* **** 01 */}
                ...
                <details className="p-4 pb-0 border-b-2 open:pb-4 border-gray-400  ">
                 ...
                 Tillsyn av fastighet ute. Vi ser till ditt hus och tomt vid behov eller tillsyn av fastighet var fjärde eller varannan vecka, så att inget hänt som kräver åtgärd. Vi kontrollerar att alla dörrar är låsta och ser över fönster, tak, fasad. Vi ser även till att inte möbler eller annat blåst omkring. 
