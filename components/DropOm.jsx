    ...
    <div className=" py-10 relative">
        ...
        <div className="">
            <div className="max-w-4xl w-full relative leading-6">
                <h3 className="pt-2 text-3xl text-center mb-5 left-5">Vanliga frågor om vår Trädgårdsservice</h3>
                   <div>
...
<div className="">
                <details className="p-4 rounded-lg ">
                    ...
                    <div className="mt-3">
                        ...
                        Ja, vi tar med allt vi behöver så som gräsklippare, röjsåg, spadar, kratta, trimmer,lövblås, säckar för avfall etc. Vid vattning behöver ni dock tillhandahålla slang och tillgång till vatten.
...
<div className="">
                <details className="p-4 rounded-lg ">
                  ...
                  Ja,när du anlitar Östanå Hemservice för dina trädgårdsbehov,är det oftast jag, Björn, som kommer att utföra arbetet. <Link className="text-orange-600 font-medium" href="tel:0706898999"  >Ring mig gärna 070-689 89 99 </Link>
