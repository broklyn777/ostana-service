     ...
     <section className="pb-10">
          <div className="text-gray-text  grid gap-4 grid-cols-1 text-center mt-6 md:mt-20 mb-4 md:mb-16">
            ...
            <div className=" mx-auto text-center max-w-2xl ">
              <p >Vi erbjuder Hemservice med RUT-avdrag som omfattar trädgårdsarbeten, klippa gräs, kratta och blåsa löv, vårstädning, bortforsling.  Åkersberga/Österåker och Norrtälje kommun. Lång erfarenhet av tomt och trädarbeten. <span className=""> <br /> Björn Jansson
          ...
          {/* <ul className="text-gray-text grid grid-cols-1 gap-6 sm:grid-cols-2 text-2xl mt-8 font-[400] px-8  ">
            ...
            <li className=" border-b-2 border-gray-light pb-2 items-center ">   <Link href='/tradgardshjalp'>
              <a className='flex items-center'>
                <div className="mr-6 w-8 h-8 items-center flex:none"> <GiRake /> </div> <span className="flex-1"> Läs mer här  </span> <span className="text-gray-700 font-thin text-xl ml-4"> <FaAngleRight /> </span>
              </a>
            </Link>
            </li>
            <li className=" border-b-2 border-gray-light pb-2 items-center ">   <Link href='/tradgardshjalp'>
